...
main() {
    ...
    SUBNET_ID=""
    SECURITY_GROUP_IDS="sg-0e5f2f0c7377f7402"  # Add your security group IDs separated by space
    INSTANCE_NAME="Shell-Script-EC2-Demo"

    # Call the function to create the EC2 instance
    create_ec2_instance "$AMI_ID" "$INSTANCE_TYPE" "$SUBNET_ID" "$SECURITY_GROUP_IDS" "$INSTANCE_NAME"
